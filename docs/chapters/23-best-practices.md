---
layout: default
title: "Chapter 23: Best Practices and Common Pitfalls"
parent: "Part VI: Implementation Guide"
nav_order: 23
permalink: /chapters/23-best-practices/
---
...
|---------|-----------|--------------|
| **Email** | Weekly | Tips, updates, stories |
...
**The "Zero Extra Clicks" Goal:**
Knowledge should be available and contributable within existing tools with minimal context switching.
...
| **Email** | Knowledge article creation | "Create article" button |
...
**Mistake:** Purchased enterprise content management platform ($750K) based on vendor demo
**Result:** After 18 months, <15% adoption, minimal content, user frustration
**Recovery:** Paused implementation, developed KM strategy, redesigned approach, relaunched successfully in Year 3
...
**The 80/20 Rule:**
Capture the 20% of knowledge that solves 80% of problems first.
...
**The 100-Article Principle:**
Better to have 100 excellent articles that solve 80% of problems than 10,000 mediocre articles where nothing can be found.
...
**The Reality:**
When KM is perceived as extra work, it always loses to "real work" in priority battles.
...
| **Email** | Plugin/extension | Create article from email |
...
| Previous | Up | Next |
|----------|-------|------|
| [← Chapter 22: Technology and Tools](/KnowledgeManagementHandbook/chapters/22-technology/) | [Part VI: Implementation Guide](/KnowledgeManagementHandbook/part6-implementation/) | [Chapter 24: Maturity Model →](/KnowledgeManagementHandbook/chapters/24-maturity/) |
